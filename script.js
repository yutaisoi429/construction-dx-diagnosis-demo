...
const TOOLS = [
  ...
  { id: "kanna_free", name: "KANNA（無料プラン）", category: ["photo", "site_share"], phase: ["A"], cost_min: 0, cost_label: "無料〜", type: "saas", url: "https://lp.kanna4u.com/", desc: "現場日報・写真管理・チャット（無料で開始可）" },
  { id: "kanna", name: "KANNA", category: ["site_share", "photo", "schedule"], phase: ["B"], cost_min: 5500, cost_label: "〜数万円/月", type: "saas", url: "https://lp.kanna4u.com/", desc: "現場情報共有・日報・チャット・工程管理" },
  { id: "kaname", name: "Kaname（要〜KANAME〜）", category: ["site_share", "safety"], phase: ["B"], cost_min: null, cost_label: "要問合せ", type: "saas", url: "https://www.pluscad.jp/products/kaname/", desc: "現場管理・協力会社連携に特化した軽量SaaS" },
  ...
  { id: "jobcan", name: "ジョブカン勤怠管理", category: ["labor"], phase: ["B"], cost_min: 200, cost_label: "200円/人/月〜", type: "saas", url: "https://jobcan.ne.jp/", desc: "GPS打刻・直行直帰・残業時間・給与連携" },
  ...
  { id: "craftbank", name: "クラフトバンクオフィス", category: ["cost", "estimate", "contract"], phase: ["C"], cost_min: null, cost_label: "要問合せ", type: "saas", url: "https://craft-bank.com/", desc: "原価・見積・発注・請求を一元管理" },
  { id: "andpad", name: "ANDPAD", category: ["site_share", "schedule", "photo", "estimate", "cost"], phase: ["C"], cost_min: null, cost_label: "要問合せ（数万円〜）", type: "saas", url: "https://andpad.jp/", desc: "総合施工管理プラットフォーム" },
  { id: "anyone", name: "AnyONE", category: ["estimate", "cost", "schedule", "contract"], phase: ["C"], cost_min: null, cost_label: "要問合せ", type: "saas", url: "https://www.any-one.jp/", desc: "見積〜工程〜請求〜原価を一元管理" },
  ...
  { id: "freee", name: "freee会計 / freee人事労務", category: ["contract", "labor"], phase: ["B", "C"], cost_min: 1980, cost_label: "1,980円〜/月", type: "saas", url: "https://www.freee.co.jp/", desc: "会計・給与計算をクラウドで一元化" },
...
function renderToolCard(tool) {
  ...
  return `<article class="recommend-tool-card">
    <div class="tool-card-head"><span class="brand-logo">${logoText(tool.name)}</span><strong>${tool.name}</strong><span class="type-pill">${tool.type}</span></div>
