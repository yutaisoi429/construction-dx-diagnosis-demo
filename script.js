...
const TOOLS = [
  ...
  { id: "craftbank", name: "クラフトバンク", category: ["cost", "estimate", "contract"], phase: ["C"], cost_min: null, cost_label: "要問合せ", type: "saas", url: "https://craftbank.co.jp", desc: "原価・見積・発注・請求を一元管理" },
